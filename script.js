...
const texts = {
  it: {
    ...
    tokenInfo: "Riceverete 2 gettoni da stampare con Ariana, che gestisce il photobooth. Contattatela su WhatsApp, il link è qui sotto.",
  ...
  en: {
    ...
    tokenInfo: "You will receive 2 tokens to print photos with Ariana, who manages the photobooth. Contact her on WhatsApp using the link below.",
    whatsappMsg: "Hi! I'm from the wedding and need to send you photos",
    menu: [
  ...
  fr: {
    ...
    tokenInfo: "Vous recevrez 2 jetons pour imprimer des photos avec Ariana, responsable du photobooth. Contactez-la sur WhatsApp via le lien ci-dessous.",
    whatsappMsg: "Bonjour ! Je suis du mariage et je dois vous envoyer des photos",
    menu: [
  ...
  es: {
    ...
    tokenInfo: "Recibirán 2 fichas para imprimir fotos con Ariana, que gestiona el photobooth. Contáctala por WhatsApp usando el enlace de abajo.",
    whatsappMsg: "¡Hola! Soy de la boda y necesito enviarte fotos",
    menu: [
  ...
  // --- START: Added Finnish ---
    ...
    tokenInfo: "Saat 2 polettia valokuvien tulostamiseen Ariana kanssa, joka hoitaa photoboothia. Ota häneen yhteyttä WhatsAppilla alla olevan linkin kautta.",
    whatsappMsg: "Hei! Olen häistä ja minun pitää lähettää sinulle kuvia",
    menu: [
